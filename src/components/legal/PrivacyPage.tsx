          ...
          <div className="prose prose-gray max-w-none">
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-blue-800">
                Stridr ("we," "our," or "us") respects your privacy and is committed to protecting your personal data. 
                This privacy policy explains how we collect, use, share, and protect your information when you use our 
                running training application and related services, including integrations with third-party fitness platforms 
                like Garmin Connect.
              </p>
            </div>
            ...
            <ul>
              ...
              <li><strong>Training Preferences:</strong> Goals, experience level, preferred units, and training history</li>
            ...
            <ul>
              <li><strong>Workout Data:</strong> Training plans, completed workouts, performance metrics, and progress tracking</li>
              <li><strong>Third-Party Fitness Data:</strong> Data imported from connected services (Garmin Connect, Strava, etc.)</li>
              <li><strong>Device Data:</strong> Information from connected fitness devices and wearables</li>
              <li><strong>Location Data:</strong> GPS routes and location information (only when explicitly authorized)</li>
            </ul>

            <h3>1.3 Automatically Collected Information</h3>
            <ul>
              <li><strong>Usage Analytics:</strong> How you interact with our app, features used, and performance data</li>
              <li><strong>Technical Data:</strong> IP address, browser type, device information, and operating system</li>
              <li><strong>Cookies and Tracking:</strong> Session data, preferences, and analytics cookies</li>
              <li><strong>Error Logs:</strong> Technical issues and crash reports to improve app stability</li>
            </ul>
            ...
            <ul>
              <li>When you authorize connections to third-party services (Garmin Connect, Strava, etc.)</li>
              <li>When you choose to share your training data or achievements publicly</li>
              <li>When you participate in community features or social sharing</li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>Analytics Providers:</strong> Aggregated, anonymized usage analytics</li>
              <li><strong>Payment Processors:</strong> Secure payment processing (we do not store payment details)</li>
            </ul>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 my-4">
              <h3 className="text-green-900 font-semibold mb-2">🏃‍♂️ Garmin Connect Integration</h3>
              <p className="text-green-800">
                When you connect your Garmin account, we access and use your activity data solely to provide our training services. 
                This includes workout imports, training plan synchronization, and performance analysis. We respect Garmin's 
                data usage policies and your privacy preferences.
              </p>
            </div>

            <h3>4.1 What We Access</h3>
            <ul>
              <li><strong>Workout Data:</strong> Training sessions, runs, and activity metrics</li>
              <li><strong>Performance Metrics:</strong> Pace, distance, heart rate, and other fitness data</li>
              <li><strong>Training History:</strong> Past workouts to inform training plan recommendations</li>
              <li><strong>Device Information:</strong> Connected Garmin devices and their capabilities</li>
            </ul>

            <h3>4.2 How We Use This Data</h3>
            <ul>
              <li>Generate personalized training plans based on your fitness level and history</li>
              <li>Sync workouts to your Garmin device calendar</li>
              <li>Provide performance analysis and progress tracking</li>
              <li>Adjust training recommendations based on completed workouts</li>
              <li>Enable seamless integration between Stridr and your Garmin ecosystem</li>
            </ul>

            <h3>4.3 Data Control</h3>
            <ul>
              <li>You can disconnect third-party integrations at any time</li>
              <li>Disconnecting will stop new data access but may retain previously synced data</li>
              <li>You can request deletion of all imported data from your account</li>
              <li>We respect the privacy settings you've configured on third-party platforms</li>
            </ul>
            ...
            <ul>
              ...
              <li>Personal data is anonymized or pseudonymized when possible</li>
              <li>Regular data audits to ensure compliance with privacy principles</li>
            </ul>
            ...
            <p>
              ...
              We cannot guarantee absolute security, but we continuously work to protect your information and will notify 
              you of any security breaches as required by law.
            </p>
            ...
            <ul>
              ...
              <li><strong>Training Data:</strong> Workout and fitness data retained to maintain training history and insights</li>
              <li><strong>Legal Requirements:</strong> Some data may be retained longer if required by law</li>
            </ul>

            <h3>6.2 Account Deletion</h3>
            <ul>
              <li>You can delete your account at any time through your profile settings</li>
              <li>Account deletion will remove your personal data within 30 days</li>
              <li>Some anonymized data may be retained for analytics and service improvement</li>
              <li>Backup systems may retain data for up to 90 days for recovery purposes</li>
            </ul>
            ...
            <ul>
              <li><strong>Data Access:</strong> Request a copy of all personal data we hold about you</li>
              <li><strong>Data Portability:</strong> Export your training data in standard formats</li>
              <li><strong>Account Information:</strong> View and update your profile and preferences</li>
            </ul>

            <h3>7.2 Control and Deletion</h3>
            <ul>
              <li><strong>Data Correction:</strong> Update or correct inaccurate personal information</li>
              <li><strong>Data Deletion:</strong> Request deletion of your personal data (right to be forgotten)</li>
              <li><strong>Processing Restriction:</strong> Limit how we process your data in certain circumstances</li>
            ...
            <ul>
              ...
              <li>Choose your preferred communication channels and frequency</li>
              <li>Manage push notification settings through your device and app preferences</li>
            </ul>

            <h2>8. Cookies and Tracking Technologies</h2>
            <h3>8.1 Types of Cookies We Use</h3>
            <ul>
              <li><strong>Essential Cookies:</strong> Required for basic app functionality and authentication</li>
              <li><strong>Preference Cookies:</strong> Remember your settings and preferences</li>
              <li><strong>Analytics Cookies:</strong> Help us understand how you use our app</li>
              <li><strong>Third-Party Cookies:</strong> From integrated services like Garmin Connect</li>
            </ul>
            ...
            <ul>
              ...
              <li>Note that disabling essential cookies may affect app functionality</li>
            </ul>

            <h2>9. Children's Privacy</h2>
            <p>
              Stridr is not intended for children under the age of 16. We do not knowingly collect personal information 
              from children under 16. If you believe a child has provided us with personal information, please contact us 
              immediately, and we will take steps to remove such information and terminate the child's account.
            </p>

            <h2>10. International Data Transfers</h2>
            <p>
              Stridr operates globally, and your information may be processed and stored in countries other than your own, 
              including the United States and European Union. We ensure that:
            </p>
            <ul>
              ...
              <li>Standard contractual clauses or adequacy decisions govern transfers where required</li>
              <li>Your data receives substantially similar protection regardless of location</li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>Legitimate Interests:</strong> Service improvement, security, and analytics</li>
            ...
            <ul>
              ...
              <li>Notify you via email or app notification if you have an account</li>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 my-4">
              ...
              <ul className="space-y-1">
                <li><strong>Email:</strong> privacy@stridr.dev</li>
                <li><strong>Data Protection:</strong> dpo@stridr.dev</li>
                <li><strong>Support:</strong> support@stridr.dev</li>
                <li><strong>Website:</strong> <a href="https://stridr.dev/privacy" className="text-blue-600 hover:text-blue-500">https://stridr.dev/privacy</a></li>
              </ul>
            </div>
            ...
            <ul>
              ...
              <li>Data subject requests: Within 30 days (as required by law)</li>
            ...
            <p>
              If you're located in the European Economic Area and believe we haven't adequately addressed your concerns, 
              you have the right to lodge a complaint with your local data protection supervisory authority.
            </p>

            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h3 className="text-blue-900 font-semibold mb-2">Questions About Activity Data?</h3>
              <p className="text-blue-800">
                For specific questions about how we use your training and activity data, especially data imported from 
                Garmin Connect or other fitness platforms, please contact our Data Protection Officer at 
                <a href="mailto:dpo@stridr.dev" className="underline">dpo@stridr.dev</a>.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
              ...
              <div className="text-sm text-gray-500">
                <p>This policy is publicly available at: <strong>https://stridr.dev/privacy</strong></p>
              </div>
            </div>
          </div>
        </div>
