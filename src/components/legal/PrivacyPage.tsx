      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <p>
              When you connect third-party services (like Garmin Connect or
              Strava), we may access and store data from these services
              according to their APIs and your authorization. This data is used
            ...
            <p>
              ...
              any time, which will remove your personal data from our systems.
            </p>
            ...
            <p>
              ...
              our service and updating the "last updated" date.
            </p>
