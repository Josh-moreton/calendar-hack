      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="text-center py-12">
          <p className="text-gray-500">
            Please sign in to connect your devices and services.
          </p>
          <div className="mt-4">
            <Link
              to="/login"
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="space-y-4 text-sm text-gray-600">
          <p>
            Connecting your devices allows you to sync your training calendar
            with your favorite fitness platforms.
          </p>
          <p>
            We only request the minimum permissions necessary to sync your
            workouts. Your connection can be removed at any time from your
            profile settings.
          </p>
        </div>
      </div>
