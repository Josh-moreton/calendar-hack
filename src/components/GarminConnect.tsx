      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center py-12">
          <p className="text-gray-500">
            Please sign in to connect your devices.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        ...
        {user.garminLinked && (
          <div className="mt-4 p-3 bg-green-50 text-green-700 rounded-md text-sm">
            Successfully connected to Garmin Connect. Your workouts can now be
            synchronized.
          </div>
        )}
      </div>
      ...
      <div className="text-sm text-gray-500">
        <p>
          By connecting your accounts, your workout data will be synchronized
          between this app and your Garmin account. You can disconnect at any
          time to stop sharing data.
        </p>
      </div>
    </div>
  );
